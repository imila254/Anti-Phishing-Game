...
public class CreateFile : MonoBehaviour
{
    ...
    public static void AddValues()
    {
        ...
        {
            new HighscoreEntry { name = "Mantas", time1 = 590 , time2 = 598, time3 = 470 },
            new HighscoreEntry { name = "Matas", time1 = 540, time2 = 538, time3 = 485 },
            new HighscoreEntry { name = "Saule", time1 = 560, time2 = 517, time3 = 590 },
            new HighscoreEntry { name = "Ieva", time1 = 546, time2 = 527, time3 = 580 }
        };
